...
int TimerForKeyPress = TIMER_FOR_KEYPRESS;
...
void getKeyInput(){
	...
	if ((KeyReg0 == KeyReg1) && (KeyReg1 == KeyReg2)){
		if(KeyReg3 != KeyReg2){
			...
			if(KeyReg2 == PRESSED_STATE){
				subKeyProcess1();
				TimerForKeyPress = TIMER_FOR_KEYPRESS;
			}
		}
		else{
			TimerForKeyPress--;
	...
	KeyReg4 = KeyReg5;
	KeyReg5 = KeyReg6;
	KeyReg6 = HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_14);
	...
	KeyReg8 = KeyReg9;
	KeyReg9 = KeyReg10;
	KeyReg10 = HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_15);
